...
class Player():
    ...
    def __init__(self, desired_scale_x, desired_scale_y, Width, Height):
        ...
        self.player_sprite.image = pygame.image.load("Assets/SnowballZ/Snowball.png").convert_alpha()
...
class Enemy(Entity):
    def __init__(self):
        ...
        self.initialiser((102, 107, 102),"Assets/SnowballZ/RockHit.wav")
...
class Snowball(Entity):
    def __init__(self):
        ...
        self.position.x = random.randrange(0, 720)
        self.position.y = 0
        self.initialiser((255, 255, 255),"Assets/SnowballZ/SnowballHit.wav")
        self.tag = "snowball"
...
class Spawner():
    ...
    def __init__(self, screen):
        self.screen = screen
        self.sound = mixer.Sound("Assets/SnowballZ/SnowballPowerup.wav")
...
class Main():
    ...
    def setup_pygame(self, title, width, height):
        ...
        favicon = pygame.image.load("Assets/SnowballZ/Favicon.png").convert_alpha()
    ...
    def game(self, screen, font, WIDTH, HEIGHT):
        ...
        foreground.image = pygame.image.load("Assets/SnowballZ/Foreground.png").convert_alpha()
    ...
    def menu(self, screen, font, WIDTH, HEIGHT):
        ...
        sound = pygame.mixer.Sound("Assets/SnowballZ/Start.wav")
    ...
    def __init__(self):
        ...
        while game_state != 2:
            ...
            font = pygame.font.Font("Assets/SnowballZ/Inter.ttf", 32)
            ...
            sound = pygame.mixer.Sound("Assets/SnowballZ/Die.wav")
            sound.play()
            self.reset_state()
            score = 0
            score_int = 0
